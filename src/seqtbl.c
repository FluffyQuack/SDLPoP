...
const word seqtbl_offsets[] = {
	0x0000,         
	startrun,       //seq_1_start_run = 1,
	stand,          //seq_2_stand = 2,
	standjump,		//seq_3_standing_jump = 3,
	runjump,        //seq_4_run_jump = 4,
	turn,           //seq_5_turn = 5,
	runturn,        //seq_6_run_turn = 6,
	stepfall,		//seq_7_fall = 7,
	jumphangMed,    //seq_8_jump_up_and_grab_straight = 8,
	hang,           //seq_9_grab_while_jumping = 9,
	climbup,        //seq_10_climb_up = 10,
	hangdrop,		//seq_11_release_ledge_and_land = 11,
	freefall,       //
	runstop,        //seq_13_stop_run = 13,
	jumpup,         //seq_14_jump_up_into_ceiling = 14,
	fallhang,		//seq_15_grab_ledge_midair = 15,
	jumpbackhang,   //seq_16_jump_up_and_grab = 16,
	softland,       //seq_17_soft_land = 17,
	jumpfall,       //seq_18_fall_after_standing_jump = 18,
	stepfall2,		//seq_19_fall = 19,
	medland,        //seq_20_medium_land = 20,
	rjumpfall,      //seq_21_fall_after_running_jump = 21,
	hardland,       //seq_22_crushed = 22,
	hangfall,		//seq_23_release_ledge_and_fall = 23,
	jumphangLong,   //seq_24_jump_up_and_grab_forward = 24,
	hangstraight,   //seq_25_hang_against_wall = 25,
	rdiveroll,      //seq_26_crouch_while_running = 26,
	sdiveroll,		//
	highjump,       //seq_28_jump_up_with_nothing_above = 28,
	step1,          //seq_29_safe_step_1 = 29,
	step2,          //seq_30_safe_step_2 = 30,
	step3,			//seq_31_safe_step_3 = 31,
	step4,          //seq_32_safe_step_4 = 32,
	step5,          //seq_33_safe_step_5 = 33,
	step6,          //seq_34_safe_step_6 = 34,
	step7,			//seq_35_safe_step_7 = 35,
	step8,          //seq_36_safe_step_8 = 36,
	step9,          //seq_37_safe_step_9 = 37,
	step10,         //seq_38_safe_step_10 = 38,
	step11,			//seq_39_safe_step_11 = 39,
	step12,         //seq_40_safe_step_12 = 40,
	step13,         //seq_41_safe_step_13 = 41,
	step14,         //seq_42_safe_step_14 = 42,
	turnrun,		//seq_43_start_run_after_turn = 43,
	testfoot,       //seq_44_step_on_edge = 44,
	bumpfall,       //seq_45_bumpfall = 45,
	hardbump,       //seq_46_hardbump = 46,
	bump,			//seq_47_bump = 47,
	superhijump,    //seq_48_super_high_jump = 48,
	standup,        //seq_49_stand_up_from_crouch = 49,
	stoop,          //seq_50_crouch = 50,
	impale,			//seq_51_spiked = 51,
	crush,          //seq_52_loose_floor_fell_on_kid = 52,
	deadfall,       //
	halve,          //seq_54_chomped = 54,
	engarde,		//seq_55_draw_sword = 55,
	advance,        //seq_56_guard_forward_with_sword = 56,
	retreat,        //seq_57_back_with_sword = 57,
	strike,         //seq_58_guard_strike = 58,
	flee,			//
	turnengarde,    //seq_60_turn_with_sword = 60,
	striketoblock,  //seq_61_parry_after_strike = 61,
	readyblock,     //seq_62_parry = 62,
	landengarde,	//seq_63_guard_stand_active = 63,
	bumpengfwd,     //seq_64_pushed_back_with_sword = 64,
	bumpengback,    //seq_65_bump_forward_with_sword = 65,
	blocktostrike,  //seq_66_strike_after_parry = 66,
	strikeadv,		//
	climbdown,      //seq_68_climb_down = 68,
	blockedstrike,  //seq_69_attack_was_parried = 69,
	climbstairs,    //seq_70_go_up_on_level_door = 70,
	dropdead,		//seq_71_dying = 71,
	stepback,       //
	climbfail,      //seq_73_climb_up_to_closed_gate = 73,
	stabbed,        //seq_74_hit_by_sword = 74,
	faststrike,		//seq_75_strike = 75,
	strikeret,      //
	alertstand,     //seq_77_guard_stand_inactive = 77,
	drinkpotion,    //seq_78_drink = 78,
	crawl,			//seq_79_crouch_hop = 79,
	alertturn,      //seq_80_stand_flipped = 80,
	fightfall,      //seq_81_kid_pushed_off_ledge = 81,
	efightfall,     //seq_82_guard_pushed_off_ledge = 82,
	efightfallfwd,	//seq_83_guard_fall = 83,
	running,        //seq_84_run = 84,
	stabkill,       //seq_85_stabbed_to_death = 85,
	fastadvance,    //seq_86_forward_with_sword = 86,
	goalertstand,	//seq_87_guard_become_inactive = 87,
	arise,          //seq_88_skel_wake_up = 88,
	turndraw,       //seq_89_turn_draw_sword = 89,
	guardengarde,   //seq_90_en_garde = 90,
	pickupsword,	//seq_91_get_sword = 91,
	resheathe,      //seq_92_put_sword_away = 92,
	fastsheathe,    //seq_93_put_sword_away_fast = 93,
	Pstand,         //seq_94_princess_stand_PV1 = 94,
	Vstand,			//seq_95_Jaffar_stand_PV1 = 95,
	Vwalk,          //
	Vstop,          //
	Palert,         //
	Pstepback,		//
	Vexit,          //
	Mclimb,         //seq_101_mouse_stands_up = 101,
	Vraise,         //
	Plie,			//seq_103_princess_lying_PV2 = 103,
	patchfall,      //seq_104_start_fall_in_front_of_wall = 104,
	Mscurry,        //seq_105_mouse_forward = 105,
	Mstop,          //seq_106_mouse = 106,
	Mleave,			//seq_107_mouse_stand_up_and_go = 107,
	Pembrace,       //seq_108_princess_turn_and_hug = 108,
	Pwaiting,       //seq_109_princess_stand_PV2 = 109,
	Pstroke,        //seq_110_princess_crouching_PV2 = 110,
	Prise,			//seq_111_princess_stand_up_PV2 = 111,
	Pcrouch,        //seq_112_princess_crouch_down_PV2 = 112,
	Pslump,         //
	Mraise			//seq_114_mouse_stand = 114,
};
